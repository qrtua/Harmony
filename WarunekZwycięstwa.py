...
"""poniższą zmienną ustalono na potrzebę WarunkuZwycięstwa"""
poprawny_uklad = [[picture_1, picture_4, picture_7],
            [picture_2, picture_5, picture_8],
            [picture_3, picture_6, picture_0]]
"""powyższą zmienną ustalono na potrzebę WarunkuZwycięstwa"""
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                ...
                """poniższe stanowi wykonanie WarunkuZwycięstwa"""
                if pictures == poprawny_uklad:
                    print('zwycięstwo! 0')
                """powyższe stanowi wykonanie WarunkuZwycięstwa"""
