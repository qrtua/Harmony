...
#poniższe NADPISUJE dodana funkcjonaalność PrzycinaniaObrazków i może być usunięte/zdezaktywowane
...
"""Poniższe dodano dla PrzycinaniaObrazków"""
obrazek = pygame.image.load(os.path.join("Assets",'tiger_a.jpg')) #obrazek musi znaajdować się w assetach i mieć określoną w tej linijce nazwę
obrazek = pygame.transform.smoothscale(obrazek, (WIDTH, HEIGHT)) 

picture_1 = obrazek.subsurface(0,0,150,150) #pozycja, pozycja, wielkość, wielkość
...
#poniżej dodawane są marginesy, tworzą WYŁĄCZNIE efekt wizualny - zasłaniają część obrazków, można w nie klikać
pygame.draw.rect( picture_1 , BLACK, pygame.Rect(0, 0, 150, 150),  3) #pozycja, pozycja, wielkość figury, wielkość figury, szerokość linii = 3
...
"""Powyższe dodano dla PrzycinaniaObrazków"""
